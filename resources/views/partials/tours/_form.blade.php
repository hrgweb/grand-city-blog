<form novalidate role="form" enctype="multipart/form-data">
	...
	<div class="form-group">
		<input type="text" name="place" class="form-control" placeholder="United States" ng-model="inputs.place">
	</div>
	...
	<div class="form-group">
		...
		<b class="pull-right">Image Of Tour</b><br>
	</div>
	...
	<div class="form-group" style="clear: both;">
		<button type="submit" class="btn btn-primary" ng-show="isCreate" ng-click="addTour(inputs)">Add Tour</button>
		<button type="submit" class="btn btn-warning" ng-hide="isEdit" ng-click="updateTour(inputs)">Update Tour</button>
